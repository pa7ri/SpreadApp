...
public final class Constants {
    ...
    public static final String TUTORIAL_ARGS = "TUTORIAL_ARGS";
    ...
    public static final class LocalPreferences {
        ...
        public static final String OTHER_PREF = "PICTURE_PREF";
    ...
    public static final class Notifications {
        ...
        public static final String NOTIFICATION_DATA_OTHER =  "NOTIFICATION_DATA_OTHER";
