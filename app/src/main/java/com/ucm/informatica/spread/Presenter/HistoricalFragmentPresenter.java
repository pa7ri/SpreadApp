    ...
    private void filterItemsByCameraBounds(Pair<Pair<Double,Double>,Pair<Double,Double>> cameraBounds){
        ...
        for (Alert alert : historicalAlertList) {
            if( alert.getLatitude() != null && alert.getLongitude() != null &&
                    alert.getLatitude()>cameraBounds.first.first && alert.getLatitude()<cameraBounds.first.second
        ...
        for (Poster poster : historicalPosterList) {
            if(poster.getLatitude() != null && poster.getLongitude() != null &&
                    poster.getLatitude()>cameraBounds.first.first && poster.getLatitude()<cameraBounds.first.second
